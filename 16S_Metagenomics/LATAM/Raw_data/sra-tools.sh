#!/bin/bash
#SBATCH --job-name=sra_srr_download
#SBATCH --output=sra_srr_%j.out
#SBATCH --error=sra_srr_%j.err
...
LOG_PATH="/opt/data/HPC01A/alexis_rojasc/Metagenomics/LATAM/Raw_data"

# Create a directory for the downloaded data
OUTPUT_DIR="${LOG_PATH}/LATAM_DATA"
mkdir -p "${OUTPUT_DIR}"
...
SRR_LIST="/opt/data/HPC01A/alexis_rojasc/Metagenomics/LATAM/Raw_data/SRR.txt"   
