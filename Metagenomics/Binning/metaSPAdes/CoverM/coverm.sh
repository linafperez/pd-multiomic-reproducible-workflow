...
CONTIGS="/data_HPC02/alexis_rojasc/Metagenomics/Assembly/metaSPAdes/metaSPAdes_out/final.contigs.fa"
FINAL_OUTPUT="/data_HPC02/alexis_rojasc/Metagenomics/Binning/metaSPAdes/CoverM/Binners"
