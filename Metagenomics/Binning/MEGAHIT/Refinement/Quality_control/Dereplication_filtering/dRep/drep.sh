...
# 1. Input paths
# -----------------------------
BIN_DIR="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/Refinement/DAS_Tool/DAS-Tool_out/DASTool_DASTool_bins"
CHECKM2_REPORT="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/Refinement/Quality_control/Raw_bin/CheckM2/CheckM2_out/quality_report.tsv"
WORKDIR="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/Refinement/Quality_control/Dereplication_filtering/dRep"
OUTPUT_DIR="$WORKDIR/dRep_out"

# -----------------------------
# 2. Temporary folders 
# -----------------------------
TMP_BASE="/tmp/dRep_$SLURM_JOB_ID"
