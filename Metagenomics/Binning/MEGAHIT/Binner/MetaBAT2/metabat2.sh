...
COVERAGE="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/CoverM/Binners/MetaBAT2/depth.metabat.txt"
WORKDIR="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/Binner/MetaBAT2"
OUTPUT_DIR="$WORKDIR/MetaBAT2_out"

# -----------------------------
# 2. Temporary folders 
# -----------------------------
TMP_BASE="/tmp/MetaBAT2_$SLURM_JOB_ID"
