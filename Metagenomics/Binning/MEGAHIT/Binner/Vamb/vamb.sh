...
COVERAGE="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/CoverM/Binners/Vamb_MetaBinner/depth.vamb.cleaned.txt"
WORKDIR="/data_HPC02/alexis_rojasc/Metagenomics/Binning/MEGAHIT/Binner/Vamb"
