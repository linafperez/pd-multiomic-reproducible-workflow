...
# Input assembly
ASSEMBLY="/data_HPC02/alexis_rojasc/Metagenomics/Assembly/metaSPAdes/metaSPAdes_out/contigs.fasta"

# Output directory
OUTDIR="/data_HPC02/alexis_rojasc/Metagenomics/Assembly/metaSPAdes/MetaQuast/MetaQuast_out"
mkdir -p "$OUTDIR"
