...
This repository contains the workflow used to perform Mendelian Randomization (MR) analyses investigating potential causal relationships between gut microbiome taxa and Parkinson’s disease (PD). The pipeline reproduces the analytical procedures used in the study to evaluate genetically instrumented microbial abundances and their association with PD risk.
