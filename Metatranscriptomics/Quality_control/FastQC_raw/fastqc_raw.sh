...
# Directories
FASTQ_DIR="/data_HPC02/alexis_rojasc/Metatranscriptomics/Raw_data/Rename"
OUTPUT_DIR="/data_HPC02/alexis_rojasc/Metatranscriptomics/Quality_control/FastQC_raw/FastQC_Output"
